...
gameState.load.prototype = {
  preload: function() {
    ...
    //Background
    this.game.load.image('background', 'assets/cek.png');
    //lines
    ...
    //balle
    this.game.load.image('balle', 'assets/otak.png');
    //life
    ...
    this.game.load.audio('music', 'sounds/mus.mp3');
    this.game.load.audio('music', 'sounds/yup.mp3'); // not found
  }, //preload
  create: function() {
...
gameState.main.prototype = {
  create: function() {
    ...
    //paddle
    this.paddle = this.game.add.sprite(this.game.world.centerX, 680, 'paddle');
    ...
    livesText = this.game.add.text(780, 660, 'lives: 3', {
      font: "40px arial",
      fill: "#000000",
      align: "center"
    });
